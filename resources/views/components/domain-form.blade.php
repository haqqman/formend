    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="dashboard-box margin-top-0">
                <!-- Headline -->
                <div class="headline">
                    <h3><i class="icon-line-awesome-globe"></i> {{ $endpoint ? 'Edit' : 'Deploy a new' }} form end point.</h3>
                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                <input type="text" class="with-border" placeholder="https://domain.com"
                                       name="name" value="{{ $endpoint ? $endpoint->name : old('name') }}" required>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                <input type="text" class="with-border" placeholder="e.g. Formend Contact Form"
                                       name="email_from" value="{{ $endpoint ? $endpoint->email_from : old('email_from') }}" required>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                <input type="text" class="with-border" placeholder="e.g. You've received a submission!)"
                                       name="email_subject" value="{{ $endpoint ? $endpoint->email_subject : old('email_subject') }}"
                                       required>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                <input type="email" class="with-border" placeholder="e.g. formend@haqqman.com"
                                       name="email_primary" value="{{ $endpoint ? $endpoint->email_primary : old('email_primary') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                <input type="email" class="with-border" placeholder="e.g. formend2@haqqman.com"
                                       name="email_secondary" value="{{ $endpoint ? $endpoint->email_secondary : old('email_secondary') }}">
                            </div>
                        </div>
    ...
    @if($errors->any())
        ...
        <div class="col-xl-12">
            <button type="submit" class="button ripple-effect big margin-top-30">
                <i class="icon-feather-plus"></i> {{ $endpoint ? 'Update' : 'Deploy' }} Domain
            </button>
        </div>
    </div>
</form>
