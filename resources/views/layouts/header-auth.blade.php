            ...
            <div class="right-side">
                ...
                <div class="header-widget">
                    ...
                    <div class="header-notifications">
                        ...
                        <div class="header-notifications-dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li class="notifications-not-read">
                                            <a href="dashboard-messages.html">
                                                <span class="notification-avatar status-online"><img src="../images/formend-avatar.svg" alt=""></span>
                            ...
                            <a href="dashboard-messages.html" class="header-notifications-button ripple-effect button-sliding-icon">View All<i class="icon-material-outline-arrow-right-alt"></i></a>
                        </div>
                    </div>
                ...
                <div class="header-widget">
                    ...
                    <div class="header-notifications user-menu">
                        <div class="header-notifications-trigger">
                            <a href="#"><div class="user-avatar status-online"><img src="../images/haqqman-avatar.jpg" alt=""></div></a>
                        </div>
                        ...
                        <div class="header-notifications-dropdown">
                            ...
                            <div class="user-status">
                                ...
                                <div class="user-details">
                                    <div class="user-avatar status-online"><img src="../images/haqqman-avatar.jpg" alt=""></div>
                                    <div class="user-name">
                                ...
                                <div class="status-switch" id="snackbar-user-status">
                                    <label class="user-online current-status">Active</label>
                                    <label class="user-invisible">Inactive</label>
                                    <!-- Status Indicator -->
